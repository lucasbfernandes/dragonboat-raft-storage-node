...
build:
	CGO_ENABLED=1 $(GOCMD) -mod vendor -o build/_output/dragonboat-raft-storage-node ./cmd/dragonboat-raft-storage-node
...
image: # @HELP build dragonboat-raft-storage-node Docker image
	@go mod vendor
