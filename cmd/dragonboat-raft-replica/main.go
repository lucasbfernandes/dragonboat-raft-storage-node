...
import (
	...
	"github.com/atomix/dragonboat-raft-replica/pkg/atomix/raft"
...
func main() {
	...
	node := atomix.NewNode(nodeID, partitionConfig, raft.NewProtocol(partitionConfig, protocolConfig), registry.Registry)
